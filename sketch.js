...
trex_running = loadAnimation('cfc871a9f236b73.png');
 terraimg = loadImage('ground2.png'); 
nimg = loadImage ('cloud.png');
trexc=loadAnimation('sonicmorre.png');
o1=loadImage('planta.webp');
o2=loadImage('peixe.png');
o3=loadImage('magrelo.webp');
o4=loadImage('images.jpg');
o5=loadImage('goomba.webp');
o6=loadImage('pouvo.jpg');
...
o1.scale=0.1;
o2.scale=0.000000000000000000000000000000000000000000000000000001;
o3.scale=0.1;
o4.scale=0.1;
o5.scale=0.1;
o6.scale=0.3;
